...
opt = EasyDict()
opt.task_name = "speed_insert_200_300_400_load500"
opt.files = [1,5,9,13,16]
opt.src_domain_idx = [0,4]
opt.tgt_domain_idx = [1,2,3]
...
opt.d_loss_type = "DANN_loss"  # "DANN_loss_mean" # "CIDA_loss" # "GRDA_loss" # "DANN_loss"

opt.lambda_gan = 0.4
opt.lambda_reconstruct = 100
