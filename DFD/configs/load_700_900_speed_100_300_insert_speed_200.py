...
opt = EasyDict()
opt.task_name = "load_700_900_speed_100_300_insert_speed_200"
opt.files = [2,3,6,7,10,11]
opt.src_domain_idx = [0,1,4,5]
opt.tgt_domain_idx = [2,3]
...
opt.u_dim = 64  # the dimension of local domain index u
opt.beta_dim = 16
